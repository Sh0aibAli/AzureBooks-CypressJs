...
describe('Azure Bookcart Cart movements', () => {
    it('Add and Delete books to cart', () => {
        ...
        cy.fixture("example").then((data) => {
          ...
          cartItemPage.cardTitle().should('have.text',' Shopping cart is empty ');
      ...
      it('Add and Delete books to wishlist', () => {
        ...
        cy.fixture("example").then((data) => {
          ...
          homepage.wishlistCount().should('have.text','0');
          wishlistPage.cardTitle().should('have.text',' Your wishlist is empty ');
